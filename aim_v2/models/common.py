...
def scaled_dot_product_attention(query, key, value, attn_mask=None):
    """
    :param query: torch.Tensor -> [batch_size, n_heads, seq_len, d_k]
    :param key: torch.Tensor -> (batch_size, n_heads, seq_len, d_k)
    :param value: torch.Tensor -> (batch_size, n_heads, seq_len, d_v)
    :param attn_mask: torch.Tensor -> (batch_size, n_heads, seq_len, seq_len)
    :return: torch.Tensor -> (batch_size, n_heads, seq_len, d_v)
    """
...
class TransformerBlock(nn.Module):
    ...
    def forward(self,
        ...
        x = x + self.drop_path1(self.attn(self.norm1(x), freqs_cis, prefix_mask))
